...
build = {
    type = "builtin",
    modules = {
        ["advanced-telegram-bot-lua.config"] = "src/config.lua",
        ["advanced-telegram-bot-lua.core"] = "src/core.lua",
        ["advanced-telegram-bot-lua.tools"] = "src/tools.lua",
        ["advanced-telegram-bot-lua.b64url"] = "src/b64url.lua"
    }
}
